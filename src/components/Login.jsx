...
function Login() {
  ...
  return (
    <div
    className='flex items-center justify-center sm:w-full w-[335px] mx-auto py-10'
    >
        <div className={` w-full max-w-sm mx-auto bg-gray-100 rounded-xl p-10 border border-black/10`}>
